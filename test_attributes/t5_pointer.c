#include "prefix.h"
// doesn't work because of the bug in CDT
char *v1;
char ALIGN(8) *v2;
char *v3 ALIGN(4);
...
unsigned ALIGN(16) *v12, ALIGN(8) *v13;

int ALIGN(8) *v14 ALIGN(16);
int ALIGN(16) *v15 ALIGN(8);
int ALIGN(8) *v16 ALIGN(16), ALIGN(32) *v17 ALIGN(16), ALIGN(64) *v18 ALIGN(2); // Bug: ignoring align 32 and align 64
